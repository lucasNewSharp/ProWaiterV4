...
class ConfiguracoesAPP {
  ...
  factory ConfiguracoesAPP.fromJson(Map<String, dynamic> json) =>
      _$ConfiguracoesAPPFromJson(json);
...
class ConfiguracoesProWaiterWeb {
  ...
  factory ConfiguracoesProWaiterWeb.fromJson(Map<String, dynamic> json) =>
      _$ConfiguracoesProWaiterWebFromJson(json);
...
class TipoBebida extends Categoria {
  ...
  factory TipoBebida.fromJson(Map<String, dynamic> json) =>
      _$TipoBebidaFromJson(json);
...
class TipoRefeicao extends Categoria {
  ...
  factory TipoRefeicao.fromJson(Map<String, dynamic> json) =>
      _$TipoRefeicaoFromJson(json);
...
class LocalInterno {
  ...
  factory LocalInterno.fromJson(Map<String, dynamic> json) =>
      _$LocalInternoFromJson(json);
...
class ComponenteRefeicao {
  ...
  factory ComponenteRefeicao.fromJson(Map<String, dynamic> json) =>
      _$ComponenteRefeicaoFromJson(json);
...
class ComponenteRefeicaoPedido {
  ...
  factory ComponenteRefeicaoPedido.fromJson(Map<String, dynamic> json) =>
      _$ComponenteRefeicaoPedidoFromJson(json);
...
class BebidaDoPedido extends ItemPedido implements IClonable {
  ...
  factory BebidaDoPedido.fromJson(Map<String, dynamic> json) =>
      _$BebidaDoPedidoFromJson(json);
...
class TamanhoRefeicao {
  ...
  TamanhoRefeicao(
      {@required this.codigo, @required this.nome, @required this.posicao});

  factory TamanhoRefeicao.fromJson(Map<String, dynamic> json) =>
      _$TamanhoRefeicaoFromJson(json);
...
class RefeicaoDoCardapio {
  ...
  factory RefeicaoDoCardapio.fromJson(Map<String, dynamic> json) =>
      _$RefeicaoDoCardapioFromJson(json);
...
class RefeicaoDoPedido extends ItemPedido implements IClonable {
  ...
  bool get personalizado {
    return refeicaoDoCardapio.refeicao.componentesRefeicao.length !=
            componentesRefeicaoPedido.length ||
        !observacoes.isNullOrWhiteSpace();
  }
  ...
  factory RefeicaoDoPedido.fromJson(Map<String, dynamic> json) =>
      _$RefeicaoDoPedidoFromJson(json);
  ...
  RefeicaoDoPedido clone() {
    RefeicaoDoPedido novaRef = RefeicaoDoPedido(
        ...
        chaveParaVincluarModelo: this.chaveParaVincluarModelo,
        modeloPedido: this.modeloPedido,
        componentesRefeicaoPedido: this
            .componentesRefeicaoPedido
            .map((e) => ComponenteRefeicaoPedido(
                codComponente: e.codComponente, quantidade: e.quantidade))
            .toList());
    return novaRef;
  }
}
...
class PedidoInterno {
  ...
  bool get possuiItensNaoEnviados {
    return refeicoesDoPedido != null &&
            refeicoesDoPedido.any((r) => !r.enviadoACozinha) ||
        bebidasDoPedido != null &&
            bebidasDoPedido.any((b) => !b.enviadoACozinha);
  }
  ...
  factory PedidoInterno.fromJson(Map<String, dynamic> json) =>
      _$PedidoInternoFromJson(json);
...
class ComponenteComposicaoRefeicaoCardapio {
  ...
  factory ComponenteComposicaoRefeicaoCardapio.fromJson(
          Map<String, dynamic> json) =>
      _$ComponenteComposicaoRefeicaoCardapioFromJson(json);
  Map<String, dynamic> toJson() =>
      _$ComponenteComposicaoRefeicaoCardapioToJson(this);
}
...
class UnidadeComponenteComposicao {
  ...
  UnidadeComponenteComposicao(
      {@required this.codigo, @required this.descricao});

  factory UnidadeComponenteComposicao.fromJson(Map<String, dynamic> json) =>
      _$UnidadeComponenteComposicaoFromJson(json);
...
class ItensNaoEnviados {
  ...
  factory ItensNaoEnviados.fromJson(Map<String, dynamic> json) =>
      _$ItensNaoEnviadosFromJson(json);
...
class ModeloComponenteRefeicaoPedido {
  ...
  factory ModeloComponenteRefeicaoPedido.fromJson(Map<String, dynamic> json) =>
      _$ModeloComponenteRefeicaoPedidoFromJson(json);
...
class ModeloRefeicaoPedido {
  ...
  factory ModeloRefeicaoPedido.fromJson(Map<String, dynamic> json) =>
      _$ModeloRefeicaoPedidoFromJson(json);
...
class ModeloBebidaPedido {
  ...
  factory ModeloBebidaPedido.fromJson(Map<String, dynamic> json) =>
      _$ModeloBebidaPedidoFromJson(json);
...
class ModeloPedido {
  ...
  factory ModeloPedido.fromJson(Map<String, dynamic> json) =>
      _$ModeloPedidoFromJson(json);
