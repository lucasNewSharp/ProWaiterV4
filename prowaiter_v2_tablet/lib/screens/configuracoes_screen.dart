...
class _ConfiguracoesScreenState extends State<ConfiguracoesScreen> {
  ...
  TextEditingController _mesaController = new TextEditingController();
  ...
  void _submitForm() {
    ...
    gConfig
        .salvarIpEMesaServidor(
            _ipServidorController.text.trim(), _mesaController.text.trim())
        .then((value) {
      _voltarTelaLogin();
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    if (config != null) {
      setState(() {
        ...
        _mesaController.text = config.mesa;
      });
    }
