...
namespace ProWaiter.ICBox
{
    static class Program
    {
        ...
        private static string guid = "4E79E602-A4E7-4E6B-BCAA-FB9324AB421E";
        ...
        static void Main()
        {
            using (Mutex mutex = new Mutex(false, guid))
            {
                ...
                {
                    MessageBox.Show("O ProWaiter - ICBox já está rodando", string.Empty,MessageBoxButtons.OK , MessageBoxIcon.Warning);
                }
            }
        }
