...
namespace ProWaiter.Web.Models
{
    ...
    public class RegisterViewModel
    {
        ...
        [Required]
        [StringLength(256, MinimumLength = 5, ErrorMessage = "O nome do usuário deve ter entre 5 e 256 caracteres!")]
        [Display(Name = "Usuário")]
        public string UserName { get; set; }
        ...
        [Display(Name = "Caixa")]
        public bool EhCaixa { get; set; }

        [Display(Name = "Garçom")]
        public bool EhGarcom { get; set; }
    }
